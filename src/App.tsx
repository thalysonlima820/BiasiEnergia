...
function App() {
  ...
  return (
    <>
      ...
      <a href="https://api.whatsapp.com/send/?phone=5591984916040&text=Ol%C3%A1%2C+quero+mais+informa%C3%A7%C3%B5es%21&type=phone_number&app_absent=0" className="whatsapp-float" target="_blank" rel="noopener noreferrer">
